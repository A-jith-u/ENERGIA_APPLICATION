...
class Itpage extends StatelessWidget {
  ...
  // Sample data for IT Classrooms
  final List<Map<String, dynamic>> classrooms = const [
    {'name': 'IT-202', 'status': 'Active', 'usage_kw': 3.1, 'color': Colors.green},
    {'name': 'IT-404', 'status': 'Alert', 'usage_kw': 5.2, 'color': Colors.red},
    {'name': 'IT-Lab 1', 'status': 'Offline', 'usage_kw': 0.0, 'color': Colors.grey},
    {'name': 'IT-Seminar Hall', 'status': 'Optimal', 'usage_kw': 1.5, 'color': Colors.blue},
    {'name': 'IT-301', 'status': 'Moderate', 'usage_kw': 4.5, 'color': Colors.orange},
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('IT Classrooms'),
