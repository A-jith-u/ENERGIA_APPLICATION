...
class Electrns extends StatelessWidget {
  const Electrns({super.key});

  // Sample data for Electronics Classrooms
  final List<Map<String, dynamic>> classrooms = const [
    {'name': 'EC-202', 'status': 'Active', 'usage_kw': 3.1, 'color': Colors.green},
    {'name': 'EC-404', 'status': 'Alert', 'usage_kw': 5.2, 'color': Colors.red},
    {'name': 'EC-Lab 1', 'status': 'Offline', 'usage_kw': 0.0, 'color': Colors.grey},
    {'name': 'EC-Seminar Hall', 'status': 'Optimal', 'usage_kw': 1.5, 'color': Colors.blue},
    {'name': 'EC-301', 'status': 'Moderate', 'usage_kw': 4.5, 'color': Colors.orange},
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Electronics Classrooms'), // Corrected Title
