...
class SergeantProfilePage extends StatefulWidget {
  final Map<String, dynamic> profile;
  final String token;

  const SergeantProfilePage({
    super.key,
  ...
  @override
  State<SergeantProfilePage> createState() => _SergeantProfilePageState();
}

class _SergeantProfilePageState extends State<SergeantProfilePage> {
  ...
  Future<void> _updateProfile(String name, String email) async {
    try {
      await updateSergeantProfile(widget.token, name: name, email: email);
  ...
  Widget build(BuildContext context) {
    ...
    final sergeantId = _profile['sergeant_id']?.toString() ?? '-';
