...
class Analysis extends StatelessWidget {
  ...
  List<FlSpot> getSpots() {
    if (type == 'Monthly') {
      ...
      return List.generate(
        30,
        (i) => FlSpot(i.toDouble(), 3.0 + (i % 7) * 0.5 + (i % 3) * 0.1),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final yMax =
        type == 'Monthly'
            ? 250.0
            : 7.0; // Adjusted max Y for monthly simulation
                    ...
                    titlesData: FlTitlesData(
                      ...
                      bottomTitles: AxisTitles(
                        ...
                        sideTitles: SideTitles(
                          ...
                          getTitlesWidget:
                              getBottomTitles, // Uses the function modified above
                        ),
                      ),
                    ),
