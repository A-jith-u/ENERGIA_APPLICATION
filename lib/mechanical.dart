...
class Mechan extends StatelessWidget {
  const Mechan({super.key});

  // Sample data for Mechanical Classrooms
  final List<Map<String, dynamic>> classrooms = const [
    {'name': 'M-202', 'status': 'Active', 'usage_kw': 3.1, 'color': Colors.green},
    {'name': 'M-404', 'status': 'Alert', 'usage_kw': 5.2, 'color': Colors.red},
    {'name': 'M-Lab 1', 'status': 'Offline', 'usage_kw': 0.0, 'color': Colors.grey},
    {'name': 'M-Seminar Hall', 'status': 'Optimal', 'usage_kw': 1.5, 'color': Colors.blue},
    {'name': 'M-301', 'status': 'Moderate', 'usage_kw': 4.5, 'color': Colors.orange},
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Mechanical Classrooms'),
